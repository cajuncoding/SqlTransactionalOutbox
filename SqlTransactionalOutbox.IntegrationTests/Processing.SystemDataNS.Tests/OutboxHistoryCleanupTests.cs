...
namespace SqlTransactionalOutbox.IntegrationTests.SystemDataNS
{
    ...
    public class OutboxHistoryCleanupTests
    {
        ...
        public async Task TestOutboxHistoryCleanupTests()
        {
            ...
            await SystemDataSqlTestHelpers.PopulateTransactionalOutboxTestDataAsync(testDataSize, true);

            var sqlConnection = await SqlConnectionHelper.CreateSystemDataSqlConnectionAsync();
