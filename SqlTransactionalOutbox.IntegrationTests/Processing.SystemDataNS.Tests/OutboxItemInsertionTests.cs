...
namespace SqlTransactionalOutbox.IntegrationTests
{
    ...
    public class OutboxItemInsertionTests
    {
        ...
        public async Task TestNewOutboxItemInsertionBenchmark()
        {
            ...
            var outboxProcessor = new SqlServerDefaultOutboxProcessor<string>(warmupTransaction, testPublisher);
            ...
            outboxProcessor = new SqlServerDefaultOutboxProcessor<string>(sqlTransaction2, testPublisher);
        ...
        public async Task TestNewOutboxItemInsertionByBatch()
        {
            ...
            var testPublisher = new TestHarnessSqlTransactionalOutboxPublisher();
            var outboxProcessor = new SqlServerDefaultOutboxProcessor<string>(sqlTransaction, testPublisher);
